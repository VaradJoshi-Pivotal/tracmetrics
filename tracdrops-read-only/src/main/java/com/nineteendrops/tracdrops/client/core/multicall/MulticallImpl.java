    ...
    private ArrayList makeMulticall(TracProperties tracProperties) {
        ...
        try {
            ...
            for(CallElement call: registeredCallElements){
                ...
                Object o = results.get(resultOrder++);
                Object resultDecoded = null;
                if( o instanceof HashMap )
                {
                    Object[] objs = ((java.util.HashMap)o).values().toArray();
                    resultDecoded = returnDecoder.decode(objs[0],
                                                         tracProperties,
                                                         call.getKeptParametersForDecoder());
                }
                else
                	resultDecoded = returnDecoder.decode(((Object[])o)[0],
                                                         tracProperties,
                                                         call.getKeptParametersForDecoder());
